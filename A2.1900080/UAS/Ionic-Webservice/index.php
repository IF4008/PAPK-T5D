...
//POST data barang untuk selanjutnya akan di simpan di tabel buku
function Input_Buku($request, $response)
{
    ...
    try {
        //if($systemToken == $token){
        $db = getDB();
        $sql = "INSERT INTO buku(kode_buku, judul_buku, penulis, penerbit, tahun_penerbit, stok) VALUES(:kode_buku, :judul_buku, :penulis, :penerbit, :tahun_penerbit, :stok)";
        $stmt = $db->prepare($sql);
        ...
        $stmt->bindParam("tahun_penerbit", $tahun_penerbit, PDO::PARAM_STR);
...
function Edit_Buku($request, $response)
{
    ...
    try {
        //if($systemToken == $token){
        $db = getDB();
        $sql = "UPDATE buku SET kode_buku=:kode_buku, judul_buku=:judul_buku, penulis=:penulis, penerbit=:penerbit, tahun_penerbit=:tahun_penerbit, stok=:stok WHERE id_buku=:id_buku";
        $stmt = $db->prepare($sql);
        $stmt->bindParam("id_buku", $id_buku, PDO::PARAM_STR);
        $stmt->bindParam("kode_buku", $kode_buku, PDO::PARAM_STR);
        $stmt->bindParam("judul_buku", $judul_buku, PDO::PARAM_STR);
